                        ...
                        <div>
                            ...
                            <nz-dropdown-menu #chatSetting="nzDropdownMenu">
                                <ul class="bg-white dark:bg-[#010413] py-1 shadow-[0_5px_30px_#9299b820] dark:shadow-[0_5px_30px_rgba(1,4,19,.60)]  rounded-md" nz-menu>
                                    <li class="flex items-center px-3 py-1.5 gap-2 text-body dark:text-white/60 text-sm hover:bg-primary/10 hover:text-primary dark:hover:text-white/[.87] capitalize" >
                                        ...
                                        <div class="flex items-center gap-[15px]">
                                            ...
                                            <nz-dropdown-menu #emojiAction="nzDropdownMenu">
                                                <ul class="bg-white dark:bg-[#010413] py-1 px-2 gap-2 shadow-[0_5px_30px_#9299b820] dark:shadow-[0_5px_30px_rgba(1,4,19,.60)] rounded-md inline-flex items-center" nz-menu>
                                                    <li class="bg-transparent flex items-center gap-2 text-body dark:text-white/60 text-sm capitalize " >
                                                    ...
                                                    <li class="bg-transparent flex items-center gap-2 text-body dark:text-white/60 text-sm capitalize " ><a href="#" class="hover:scale-125 transition ease-in-out delay-150"><span nz-icon nzType="smile" [nzTheme]="'twotone'" [nzTwotoneColor]="'#f7b835'"></span></a> </li>
                                                    <li class="bg-transparent flex items-center gap-2 text-body dark:text-white/60 text-sm capitalize " ><a href="#" class="hover:scale-125 transition ease-in-out delay-150"><span nz-icon nzType="meh" [nzTheme]="'twotone'" [nzTwotoneColor]="'#f77f28'"></span></a></li>
                                                    <li class="bg-transparent flex items-center gap-2 text-body dark:text-white/60 text-sm capitalize " ><a href="#" class="hover:scale-125 transition ease-in-out delay-150"><span nz-icon nzType="heart" [nzTheme]="'twotone'" [nzTwotoneColor]="'#eb2f96'"></span></a></li>
                                                </ul>
                                            </nz-dropdown-menu>
                                            <nz-dropdown-menu #chatAction="nzDropdownMenu">
                                                <ul class="bg-white dark:bg-[#010413] py-1 shadow-[0_5px_30px_#9299b820] dark:shadow-[0_5px_30px_rgba(1,4,19,.60)] rounded-md" nz-menu>
                                                    <li class="flex items-center px-3 py-1.5 gap-2 text-body dark:text-white/60 text-sm hover:bg-primary/10 hover:text-primary dark:hover:text-white/[.87] capitalize " >Copy</li>
                                                    <li class="flex items-center px-3 py-1.5 gap-2 text-body dark:text-white/60 text-sm hover:bg-primary/10 hover:text-primary dark:hover:text-white/[.87] capitalize " >Edit</li>
                                                    <li class="flex items-center px-3 py-1.5 gap-2 text-body dark:text-white/60 text-sm hover:bg-primary/10 hover:text-primary dark:hover:text-white/[.87] capitalize " >Forward</li>
                                                    <li class="flex items-center px-3 py-1.5 gap-2 text-body dark:text-white/60 text-sm hover:bg-primary/10 hover:text-primary dark:hover:text-white/[.87] capitalize " >remove</li>
                                                </ul>
                                            </nz-dropdown-menu>
                                        </div>
                                    </div>
