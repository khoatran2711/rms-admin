      ...
      <div class="px-[25px] pt-0 pb-[25px] min-h-[345px]">
        ...
        >
          <div class="overflow-x-auto w-full">
            <nz-table
              [nzData]="memberProgressData[tab.key]"
            ...
            >
              <tbody class="bg-white dark:bg-[#1b1d2a]">
                <tr
                  *ngFor="let product of memberProgressData[tab.key]"
                  class="group"
                >
                  <td
                  ...
                  >
                    <div class="flex items-center gap-[10px]">
                      <div
                        class="overflow-hidden flex justify-center relative w-[32px] h-[32px] rounded-[8px] bg-{{
                          product.progress
                        }}/10"
                      >
                        <img
                          class="absolute bottom-0"
                          src="assets/images/progress/{{ product.userImg }}"
                          [alt]="product.userImg"
                        />
                      </div>
                      <span
                  ...
                  <td
                    class="ps-4 pe-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-theme-gray dark:text-white/[.87] border-none group-hover:bg-transparent rounded-e-[4px] whitespace-nowrap"
                  >
                    {{ '$' + product.salary }}
                  </td>
                  <td
                    class="ps-4 pe-4 py-2.5 font-normal last:text-end capitalize text-[14px] text-light dark:text-white/[.87] border-none group-hover:bg-transparent rounded-e-[4px]"
                  >
                    {{ product.workOn }}
                  </td>
                  <td
                  ...
                  >
                    <div
                      class="d-flex align-center justify-content-end min-w-[11.25rem]"
                    >
                      <nz-progress
                        class="member-progress text-{{
                          product.progress
                        }} group/item text-{{ product.progress }}"
                        [nzPercent]="product.status"
                      ></nz-progress>
                    </div>
                  </td>
                </tr>
