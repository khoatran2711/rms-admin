  ...
  template: `
    <div class="pt-6 pb-10">
      <nz-breadcrumb [nzSeparator]="iconTemplate">
        <nz-breadcrumb-item
          ><a
            class="text-sm text-dark dark:text-white/[.87] hover:text-primary"
            [routerLink]="['/pages/knowledge-base/knowledge']"
            >Doc Home</a
          ></nz-breadcrumb-item
        >
        <nz-breadcrumb-item class="text-light-extra dark:text-white/60"
          >Plugins</nz-breadcrumb-item
        >
      </nz-breadcrumb>
      <ng-template #iconTemplate
        ><span
          class="text-[10px] text-light-extra"
          nz-icon
          nzType="right"
        ></span
      ></ng-template>
    ...
    <div
      class="flex justify-between flex-start lg:flex-col gap-x-[100px] gap-y-[40px] mb-14 flex-wrap"
    >
      <div nz-row nzGutter="50" *ngFor="let section of jsonData">
        <div nz-col nzXs="24" nzXl="8">
          <div class="min-w-[260px] sm:min-w-full">
            <h2 class="text-dark dark:text-white/[.87] text-[23px] font-medium">
          ...
          <div nz-row nzGutter="50">
            <div nz-col nzXs="24" nzXl="12">
              <ul class="flex flex-col flex-wrap mb-0">
                <li class="mb-4" *ngFor="let item of section.sections[0].items">
                  <a
                    class="font-normal text-body dark:text-white/60 hover:text-primary text-15"
            ...
            <div nz-col nzXs="24" nzXl="12">
              <nz-collapse nzAccordion>
                <nz-collapse-panel
                  *ngFor="let panel of section.sections[1].panels"
                  [nzHeader]="panel.name"
    ...
    <div class="pt-[54px] border-t border-normal dark:border-white/10">
      <div class="text-center">
        ...
        <p
          class="mb-[30px] text-body dark:text-white/60 text-[15px] font-normal"
        >
  ...
  styles: [
    `
      :host
        ::ng-deep
        nz-breadcrumb
        nz-breadcrumb-item:not(:last-child)
