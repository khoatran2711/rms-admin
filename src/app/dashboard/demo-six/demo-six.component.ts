...
// import { ChartOptions } from '../../container/dashboard/demoSix/chart-oprions';
...
export class DemoSixComponent {
  ...
  customChartOptions1: Partial<any> = {
    series: [{
      name: "Total sales",
  ...
  customChartOptions2: Partial<any> = {
    series: [{
      name: "Total Orders",
  ...
  customChartOptions3: Partial<any> = {
    series: [{
