...
@Component({
  ...
  template: `
    ...
    >
      ...
      >
        <h4
          class="mb-0 text-[20px] leading-6 font-medium text-dark dark:text-white/[.87]"
        >
          All Support Ticket
        </h4>
        <button
      ...
      <div class="px-[25px] pb-[25px]">
        ...
        >
          ...
          >
            <div class="inline-flex items-center">
              <span class="me-2 dark:text-white/60">Id:</span>
              <input
            ...
            >
              <thead>
                <tr>
                  ...
                  <th
                    class="bg-regularBG dark:bg-[#323440] px-[20px] py-[16px] text-end text-dark dark:text-white/[.87] text-[15px] font-medium border-none before:hidden rounded-e-[10px] capitalize "
                  >
                    Actions
                  </th>
                </tr>
              ...
              <tbody>
                <tr
                  class="group max-lg:whitespace-nowrap"
                  *ngFor="let person of filteredPeople"
                >
                  <td
                    class="ltr:pr-[20px] rtl:pl-[20px] text-theme-gray dark:text-white/60 font-medium text-[15px] py-4 before:hidden border-none group-hover:bg-transparent"
                  >
                    #{{ person.id }}
                  </td>
                  <td
                    ...
                    <div class="flex items-center">
                      <div class="me-2.5 w-[34px] h-[34px]">
                        <img
                          ...
                          src="assets/images/avatars/{{ person.user }}"
                          alt="Samsung Galaxy S8 256GB"
                        />
                      </div>
                      <span
                        class="font-medium capitalize text-dark dark:text-white/[.87] text-15"
                        >{{ person.name }}</span
                      >
                    </div>
                  </td>
        ...
        <div
          class="border-t border-regular dark:border-white/10 pt-[30px] mt-[10px] flex justify-center"
        >
    ...
    return this.people.filter(
      (person) =>
        ...
        (this.statusFilter === 'all' ||
          person.actions.toLowerCase() === this.statusFilter.toLowerCase())
    );
  }
