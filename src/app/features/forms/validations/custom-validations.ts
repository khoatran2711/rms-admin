    ...
    >
      ...
      <nz-form-item nzGutter="25" class="mb-0">
        <nz-form-control
          ...
          nzXs="24"
          class="mb-[10px]"
          nzErrorTip="The input is not valid City!"
        >
          <nz-form-label
            class="flex items-center [&>label]:text-dark [&>label]:dark:text-white/60 mb-[10px] p-0 text-[15px] capitalize"
            nzRequired
        ...
        <nz-form-control
          ...
          nzXs="24"
          class="mb-[10px]"
          nzErrorTip="Please input your State!"
        >
          <nz-form-label
            class="flex items-center [&>label]:text-dark [&>label]:dark:text-white/60 mb-[10px] p-0 text-[15px] capitalize"
            nzFor="state"
        ...
        <nz-form-control
          ...
          nzXs="24"
          class="mb-[10px]"
          nzErrorTip="The input is not valid Zip!"
        >
          <nz-form-label
            class="flex items-center [&>label]:text-dark [&>label]:dark:text-white/60 mb-[10px] p-0 text-[15px] capitalize"
            nzRequired
      ...
      <nz-form-item nz-row class="register-area" class="mt-[15px]">
        <nz-form-control>
          <label
            class="text-light dark:text-white/60 text-[15px] capitalize"
            nz-checkbox
