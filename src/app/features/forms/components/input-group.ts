  ...
  <nz-row nzGutter="25">
    ...
    <nz-col nzMd="12" nzXs="24" class="mb-[25px]">
      ...
      <ng-template #prefixTemplateEnvelope>
        <span class="text-light dark:text-white/60">
          <svg-icon class="[&>svg]:w-[18px] [&>svg]:h-[18px] text-current dark:text-current text-18" src="https://hexadash-angular.vercel.app/assets/images/svg/unicons-line/envelope.svg"></svg-icon>
        </span>
      </ng-template>
    </nz-col>
    <nz-col nzMd="12" nzXs="24" class="mb-[25px]">
      ...
      <ng-template #prefixTemplateLocation>
        <span class="text-light dark:text-white/60">
          <svg-icon class="[&>svg]:w-[18px] [&>svg]:h-[18px] text-current dark:text-current text-18" src="https://hexadash-angular.vercel.app/assets/images/svg/unicons-line/location-point.svg"></svg-icon>
        </span>
      </ng-template>
    </nz-col>
    <nz-col nzMd="12" nzXs="24" class="mb-[25px]">
      <nz-input-group class="before:hidden flex items-center shadow-none py-[10px] px-[20px] h-[50px] border-1 border-normal dark:border-white/10 w-full text-[14px] font-normal leading-[1.5] dark:bg-white/10 rounded-4 gap-[10px]" [nzPrefix]="prefixTemplatePassword" [nzSuffix]="suffixTemplate">
        ...
        <ng-template #prefixTemplatePassword>
          <span class="text-light dark:text-white/60">
            <svg-icon class="[&>svg]:w-[18px] [&>svg]:h-[18px] text-current dark:text-current" src="https://hexadash-angular.vercel.app/assets/images/svg/unicons-line/lock.svg"></svg-icon>
          </span>
        </ng-template>
      </nz-input-group>
    </nz-col>
    <nz-col nzMd="12" nzXs="24" class="mb-[25px]">
      ...
      <ng-template #prefixTemplatePayment>
        <span class="text-light dark:text-white/60">
          <svg-icon class="[&>svg]:w-[18px] [&>svg]:h-[18px] text-current dark:text-current text-18" src="https://hexadash-angular.vercel.app/assets/images/svg/unicons-line/credit-card.svg"></svg-icon>
        </span>
      </ng-template>
    </nz-col>
    <nz-col nzMd="12" nzXs="24" class="mb-[25px]">
      ...
      <ng-template #prefixTemplatePhone>
        <span class="text-light dark:text-white/60">
          <svg-icon class="[&>svg]:w-[18px] [&>svg]:h-[18px] text-current dark:text-current text-18" src="https://hexadash-angular.vercel.app/assets/images/svg/unicons-line/phone.svg"></svg-icon>
        </span>
      </ng-template>
    </nz-col>
  </nz-row>
