...
@Component({
  ...
  template: `
    ...
    >
      <nz-form-item>
        <nz-form-label
          class="flex items-center font-medium dark:text-white/60"
          [nzSm]="6"
          [nzXs]="24"
          nzRequired
          nzFor="email"
          ...
          <nz-input-group [nzAddOnBefore]="addOnBeforeTemplate">
            <ng-template #addOnBeforeTemplate>
              <nz-select
                ...
                class="phone-select text-dark dark:text-white/[.87] w-[70px]"
              >
            ...
            <input
              class="w-full rounded-e-4 border-normal border-1 text-[15px] dark:bg-white/10 dark:border-white/10 px-[20px] py-[12px] min-h-[50px] outline-none placeholder:text-[#A0A0A0] text-theme-gray dark:text-white/60"
        ...
        >
          <div nz-row [nzGutter]="8">
            ...
            <div nz-col [nzSpan]="10">
              <button
                class="bg-normal dark:bg-white/30 border-solid border-1 border-normal dark:border-white/10 text-dark dark:text-white/[.87] text-[14px] font-semibold leading-[22px] w-full flex items-center justify-center rounded-[4px] px-[20px] h-[50px] duration-300 "
                nz-button
      ...
      >
        <nz-form-control [nzSpan]="14" [nzOffset]="6">
          <label nz-checkbox formControlName="agree">
            <span class="text-theme-gray dark:text-white/60"
              >I have read the <a class="text-primary">agreement</a></span
            >
          </label>
        </nz-form-control>
      </nz-form-item>
...
export class NzDemoFormRegisterComponent implements OnInit {
  ...
  inputClass =
    'w-full rounded-4 border-normal border-1 text-[15px] dark:bg-white/10 dark:border-white/10 px-[20px] py-[12px] min-h-[50px] outline-none placeholder:text-[#A0A0A0] text-theme-gray dark:text-white/60';
