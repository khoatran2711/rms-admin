...
@Component({
    ...
    >
        ...
        <div nz-row [nzGutter]="8">
          ...
          <div nz-col nzSpan="12">
            <nz-form-item>
              <nz-form-label
                class="flex items-center font-medium dark:text-white/60"
                >DateTime</nz-form-label
              >
              <nz-form-control>
                <nz-range-picker
                  class="inline-flex items-center rounded-4 border-normal border-1 text-[15px] dark:bg-white/10 dark:border-white/10 px-[20px] py-[8px] h-[46px] outline-none placeholder:text-light placeholder:font-normal text-theme-gray dark:text-white/60 w-full mb-[15px]"
                ></nz-range-picker>
              </nz-form-control>
            </nz-form-item>
          </div>
      ...
      <ng-template #footerTpl>
        <div style="float: right">
          <button
            nz-button
            class="me-[8px] dark:bg-transparent border-regular dark:border-white/10 dark:text-white/[.87] rounded-4 py-[4px] px-[15px]"
            (click)="close()"
          >
            Cancel
          </button>
          <button
            nz-button
            class="bg-primary border-primary hover:bg-primary-hbr text-white rounded-4 py-[4px] px-[15px]"
            (click)="close()"
          >
            Submit
          </button>
  ...
  styles: [
    `
      ...
      :host
        ::ng-deep
        .basic-select.ant-select-multiple
