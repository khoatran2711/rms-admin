...
@Component({
  ...
  template: `
    <ng-template #drawerTemplate let-data let-drawerRef="drawerRef">
      ...
      <button
        nz-button
        class="bg-danger hover:bg-primary-hbr border-solid border-1 border-danger text-white text-[14px] font-semibold leading-[22px] inline-flex items-center justify-center rounded-[4px] px-[20px] h-[44px]"
